<div wire:key="{{ $todo->id }}"
    ...
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:click="delete({{ $todo->id }})" wire:loading.remove wire:target="delete"
                onclick="document.querySelector(`#edit_button_{{ $todo->id }}`).style.display=`none`;"
            ...
            <span wire:loading wire:target="delete" class="inline-block px-0 my-0 font-italic text-red-700"
                style="display:none;">
                Deleting...
            </span>
        </div>
