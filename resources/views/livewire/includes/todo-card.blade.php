    ...
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex items-center">
            ...
            @if ($editTodoId === $todo->id)
                <input wire:model="edtiTodoName" type="text" placeholder="Todo.."
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:key="bt_edit_{{ $todo->id }}" wire:click="edit({{ $todo->id }})"
            ...
            <button wire:key="bt_del_{{ $todo->id }}" wire:click="delete({{ $todo->id }})" wire:loading.remove
                wire:target="delete" @click="hideElement(`#edit_button_{{ $todo->id }}`);"
            ...
            <span wire:key="load_del_{{ $todo->id }}" wire:loading wire:target="delete"
